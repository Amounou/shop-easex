    ...
    <div className="min-h-screen bg-hero flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl border border-border p-8 shadow-sm">
          ...
          <p className="text-sm text-muted-foreground text-center mb-6">Commencez à vendre en quelques minutes</p>

          <button
            onClick={handleGoogleSignup}
            className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-border bg-background hover:bg-secondary transition-colors text-sm font-medium text-foreground mb-6"
          >
          ...
          <p className="text-xs text-center text-muted-foreground mt-4">
            ...
            <Link to="/terms" className="text-primary hover:underline">Conditions générales</Link>
            {" "}et notre{" "}
